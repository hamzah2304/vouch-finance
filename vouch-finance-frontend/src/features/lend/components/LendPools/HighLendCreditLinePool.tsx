...
export function HighLendCreditLinePool({
  poolName,
  ...
  return (
    <>
      <PoolInfo
        ...
        title='High yield credit lines'
        description='This pool consists of less creditworthy borrowers. However, we ensure these users have been vouched for by highly creditworthy users. For more detail, visit http://localhost:3000/#/vouch. You can expect 8-10% APR.'
        items={items}
        buttons={buttons}
