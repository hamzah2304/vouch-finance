...
export function LowLendCreditLinePool({ poolName }: Props): React.ReactElement {
  ...
  return (
    <>
      <PoolInfo
        ...
        title='Low yield credit lines'
        description='This pool consists of highly creditworthy borrowers. You can expect 3-6% APR.'
        items={items}
        buttons={buttons}
