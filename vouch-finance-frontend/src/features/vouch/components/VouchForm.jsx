...
export function VouchForm({ infoOneRow = false }) {
  ...
  const searchDescription =
    'Vouch for another user and increase their borrowing power.'
  const tableDescription =
    'Information about loans taken out by users you have vouched for'
  ...
  const searchButtons = useMemo(() => {
    ...
    return [<Button variant='contained'>SEARCH</Button>]
  }, [isActive])
